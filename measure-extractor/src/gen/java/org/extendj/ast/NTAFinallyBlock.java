 ...
 * recursive AST.
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\grammar\\NTAFinally.ast:6
...
public class NTAFinallyBlock extends Block implements Cloneable {
  /**
   * @aspect NTAFinally
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\frontend\\NTAFinally.jrag:82
   */
  private FinallyHost origin;
  /**
   * @aspect NTAFinally
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\frontend\\NTAFinally.jrag:84
   */
  ...
  protected void collect_contributors_Program_extractedStatementTypes(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\src\\jastadd\\NodeCollector.jrag:140
    {
  ...
  protected void contributeTo_Program_extractedStatementTypes(java.util.Collection<String> collection) {
    ...
    collection.add(("STY;NTA-Finally-Statement"));
  }
}
