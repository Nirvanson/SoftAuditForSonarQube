...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java8\\grammar\\MethodReference.ast:5
...
public class AmbiguousMethodReference extends MethodReference implements Cloneable {
  ...
  public ASTNode rewriteTo() {
    // Declared at C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java8\\frontend\\MethodReference.jrag:199
    if (!getAmbiguousName().isTypeAccess()) {
      return rewriteRule0();
    }
    // Declared at C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java8\\frontend\\MethodReference.jrag:209
    if (getAmbiguousName().isTypeAccess()) {
      return rewriteRule1();
    }
  ...
  /**
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java8\\frontend\\MethodReference.jrag:199
   * @apilevel internal
   */
  private ExprMethodReference rewriteRule0() {
{
  ...
  /**
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java8\\frontend\\MethodReference.jrag:209
   * @apilevel internal
   */
