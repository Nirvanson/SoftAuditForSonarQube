 ...
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\grammar\\Java.ast:221
...
public class MonitorExit extends Block implements Cloneable {
  /**
   * @aspect MonitorExit
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\frontend\\MonitorExit.jrag:34
   */
  protected SynchronizedStmt monitor = null;
  /**
   * @aspect MonitorExit
   * @declaredat C:\\Develop\\Diplom\\git_repo\\measure-extractor\\extendj\\java4\\frontend\\MonitorExit.jrag:36
   */
  ...
  protected void contributeTo_Program_extractedStatementTypes(java.util.Collection<String> collection) {
    ...
    collection.add(("STY;Monitor-Exit-Statement"));
  }
}
