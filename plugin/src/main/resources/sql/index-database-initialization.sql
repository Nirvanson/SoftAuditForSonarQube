...
CREATE TABLE `indicators` (
  ...
  `threshold_10` double DEFAULT '0',
  `threshold_20` double DEFAULT '0',
  `threshold_30` double DEFAULT '0',
  `threshold_40` double DEFAULT '0',
  `threshold_50` double DEFAULT '0',
  `threshold_60` double DEFAULT '0',
  `threshold_70` double DEFAULT '0',
  `threshold_80` double DEFAULT '0',
