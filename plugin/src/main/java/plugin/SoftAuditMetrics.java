...
public class SoftAuditMetrics implements Metrics {
     ...
     */
    public static final Metric<Integer> CLA = new Metric.Builder("base_cla", "Class-Declarations", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> FMC = new Metric.Builder("base_fmc", "Foreign-Method-Calls",
     ...
     */
    public static final Metric<Integer> INT = new Metric.Builder("base_int", "Interface-Declarations", Metric.ValueType.INT)
            .setDescription("Number of interfaces.").setDirection(Metric.DIRECTION_NONE).setQualitative(false)
            .setDomain(CoreMetrics.DOMAIN_GENERAL).create();
    /**
     * Number of Loop-Statements.
     */
    public static final Metric<Integer> LOS = new Metric.Builder("base_lop", "Loop-Statements", Metric.ValueType.INT)
            .setDescription("Number of loop-statements.").setDirection(Metric.DIRECTION_NONE).setQualitative(false)
            .setDomain(CoreMetrics.DOMAIN_GENERAL).create();
    /**
     * Number of Method calls.
     */
    public static final Metric<Integer> MEC = new Metric.Builder("base_fuc", "Method-Calls", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> MPA = new Metric.Builder("base_par", "Method-Parameters", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> NPR = new Metric.Builder("base_arg", "Non-Predicate-References", Metric.ValueType.INT)
            .setDescription("Number of non predicate references.").setDirection(Metric.DIRECTION_NONE).setQualitative(false)
            .setDomain(CoreMetrics.DOMAIN_GENERAL).create();
    /**
     * Number of numeric values other than 0 or 1 or 2 in the code.
     */
    public static final Metric<Integer> NUL = new Metric.Builder("base_con", "Numeric-Literals", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> PRM = new Metric.Builder("base_pme", "Private-Method-Declarations", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> PUM = new Metric.Builder("base_met", "Public-Method-Declarations", Metric.ValueType.INT)
            .setDescription("Number of public methods.").setDirection(Metric.DIRECTION_NONE).setQualitative(false)
            .setDomain(CoreMetrics.DOMAIN_GENERAL).create();
    /**
     * Number of Return Statements.
     */
    public static final Metric<Integer> RES = new Metric.Builder("base_ret", "Return-Statements", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> SOF = new Metric.Builder("base_src", "Source-Files", Metric.ValueType.INT)
            .setDescription("Number of source files.").setDirection(Metric.DIRECTION_NONE).setQualitative(false)
            .setDomain(CoreMetrics.DOMAIN_GENERAL).create();
    /**
     * Number of all Statements.
     */
    public static final Metric<Integer> STA = new Metric.Builder("base_stm", "Statements", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> STL = new Metric.Builder("base_lit", "String-Literals", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> SWC = new Metric.Builder("base_cas", "Switch-Cases", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> SWS = new Metric.Builder("base_swi", "Switch-Statements", Metric.ValueType.INT)
     ...
     */
    public static final Metric<Integer> VRE = new Metric.Builder("base_ref", "References", Metric.ValueType.INT)
    ...
    public List<Metric> getMetrics() {
        return Arrays.asList(BRA, CLA, DTY, FMC, GVA, IFS, IMP, INT, LOS, MEC, MPA, NPR, NUL, PRE, PRM, PUM, RES, RUM, SOF, STA, STL, STY, SWC, SWS, VAR, VRE, OMS, SST, OBP, DCO, DFC, CFC, COC, TST, FLE, COF, ICO, BRC, LCM, ACM, MOD, REU, SEC, MAM, AQM);
