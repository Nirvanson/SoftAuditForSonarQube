...
/**
 * Words in file-model: java-keywords, free identifiers, constants, literals, model-defined types.
 *
 * @author Jan Rucks
 * @version 1.0
 */
public enum KeyWord {
     ...
     * @param type
     */
    private KeyWord(String word, WordType type) {
        this.word = word;
        this.type = type;
    }
    ...
    /**
     * Check if a given string is a keyword or some user-defined word.
     * 
