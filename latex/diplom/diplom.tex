...
\hline
	...
	\chapter{Der Code-Quality-Index} \label{indexchapter}
		...
		\section{Anpassung für das Softwarepraktikum}
			...
			Darüber hinaus wurden die Qualitätsindikatoren dem Regelwerk entsprechend neu definiert und mit den Softwarepraktikumsprojekten der vergangenen Jahre eine Datenbasis aufgebaut. Diese sollen im folgenden kurz vorgestellt werden. Sofern dies möglich war wurden die Bezeichnungen des Originals wiederverwendet. Die genannten SonarQube-Regeln finden sich in der Dokumentation des Java-Plugins \cite{JavaPlugin}. \newline
			\begin{center}
				\tabulinesep=1.5mm
				\begin{longtabu}{|c|c|c|c|}
					\hline
  			...
  			\subsection{Indikator Duplizierter Code}
  				...
  				\begin{center}
					...
					\begin{longtabu}{|c|c|}
						...
						0\% (Maximum) & 6 \\  						
						\hline
  						25\% (oberes Quartil) & 5 \\  											\hline
  						50\% (Median) & 4 \\  						
						\hline
						75\% (unteres Quartil) & 3 \\  	
						\hline
						90\% & 2 \\  						
						\hline
						100\% (Minimum) & 1 \\  						
