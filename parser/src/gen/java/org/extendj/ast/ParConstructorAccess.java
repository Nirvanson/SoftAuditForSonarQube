...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\grammar\\GenericMethods.ast:17
...
public class ParConstructorAccess extends ConstructorAccess implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\GenericMethods.jrag:227
   */
  ...
  public NameType Define_nameType(ASTNode caller, ASTNode child) {
    if (caller == getTypeArgumentListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\GenericMethods.jrag:191
  ...
  public SimpleSet Define_lookupType(ASTNode caller, ASTNode child, String name) {
    if (caller == getTypeArgumentListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\GenericMethods.jrag:192
      int childIndex = caller.getIndexOfChild(child);
