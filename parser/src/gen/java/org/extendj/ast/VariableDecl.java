...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:82
...
public class VariableDecl extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\PrettyPrint.jadd:58
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\VariableDeclaration.jrag:173
   */
  ...
  /**
   * @aspect VariableDeclarationTransformation
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\VariableDeclaration.jrag:188
   */
  ...
  public boolean Define_isSource(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\DefiniteAssignment.jrag:63
      return true;
    }
    else {
  ...
  public boolean Define_assignmentContext(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:361
      return true;
    }
    else {
  ...
  public boolean Define_invocationContext(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:362
      return false;
    }
    else {
  ...
  public boolean Define_castContext(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:363
      return false;
    }
    else {
  ...
  public boolean Define_stringContext(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:364
      return false;
    }
    else {
  ...
  public boolean Define_numericContext(ASTNode caller, ASTNode child) {
    if (caller == getInitOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:365
      return false;
    }
    else {
