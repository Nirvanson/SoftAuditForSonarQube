...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\grammar\\Annotations.ast:2
...
public class AnnotationDecl extends InterfaceDecl implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\PrettyPrint.jadd:292
   */
  ...
  /**
   * @aspect Annotations
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Annotations.jrag:130
   */
  ...
  public boolean Define_mayUseAnnotationTarget(ASTNode caller, ASTNode child, String name) {
    if (caller == getModifiersNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Annotations.jrag:104
      return name.equals("ANNOTATION_TYPE") || name.equals("TYPE");
    }
    else {
      return super.Define_mayUseAnnotationTarget(caller, child, name);
    }
  }
  /**
   * @apilevel internal
