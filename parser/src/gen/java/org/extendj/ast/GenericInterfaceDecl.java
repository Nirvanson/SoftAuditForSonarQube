...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\grammar\\Generics.ast:3
...
public class GenericInterfaceDecl extends InterfaceDecl implements Cloneable, GenericTypeDecl {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\PrettyPrint.jadd:113
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:648
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:1454
   */
   ...
   * @attribute inh
   * @aspect GenericsTypeCheck
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:657
   */
  @ASTNodeAnnotation.Attribute
  ...
  public boolean Define_isNestedType(ASTNode caller, ASTNode child) {
    if (caller == getTypeParameterListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:714
  ...
  public TypeDecl Define_enclosingType(ASTNode caller, ASTNode child) {
    if (caller == getTypeParameterListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:715
      int childIndex = caller.getIndexOfChild(child);
      return this;
    }
    else {
  ...
  public SimpleSet Define_lookupType(ASTNode caller, ASTNode child, String name) {
    if (caller == getBodyDeclListNoTransform()) {
      ...
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\Generics.jrag:728
      int childIndex = caller.getIndexOfChild(child);
      {
  ...
  public int Define_typeVarPosition(ASTNode caller, ASTNode child) {
    if (caller == getTypeParameterListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TypeVariablePositions.jrag:46
  ...
  public boolean Define_typeVarInMethod(ASTNode caller, ASTNode child) {
    if (caller == getTypeParameterListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TypeVariablePositions.jrag:47
      int childIndex = caller.getIndexOfChild(child);
      return false;
    }
    else {
