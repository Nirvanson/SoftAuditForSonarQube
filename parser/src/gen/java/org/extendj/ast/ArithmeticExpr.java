...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:149
...
public abstract class ArithmeticExpr extends Binary implements Cloneable {
  ...
  public TypeDecl Define_targetType(ASTNode caller, ASTNode child) {
    if (caller == getRightOperandNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:71
      {
      ...
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:63
      {
          if (!getLeftOperand().isPolyExpression() && !getRightOperand().isPolyExpression()) {
            return type();
          } else {
  ...
  public boolean Define_numericContext(ASTNode caller, ASTNode child) {
    if (caller == getLeftOperandNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:244
      return true;
    }
    else if (caller == getRightOperandNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:243
      return true;
    }
    else {
      return super.Define_numericContext(caller, child);
    }
  }
  /**
   * @apilevel internal
