...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\grammar\\MethodReference.ast:5
...
public class AmbiguousMethodReference extends MethodReference implements Cloneable {
  ...
  public NameType Define_nameType(ASTNode caller, ASTNode child) {
    if (caller == getAmbiguousNameNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:196
  ...
  public ASTNode rewriteTo() {
    // Declared at @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:199
    if (!getAmbiguousName().isTypeAccess()) {
      return rewriteRule0();
    }
    // Declared at @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:206
    if (getAmbiguousName().isTypeAccess()) {
      return rewriteRule1();
    }
  ...
  /**
   * @declaredat @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:199
   * @apilevel internal
   */
  private ExprMethodReference rewriteRule0() {
{
  ...
  /**
   * @declaredat @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:206
   * @apilevel internal
   */
