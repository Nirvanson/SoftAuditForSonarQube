...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:105
...
public class AssignSimpleExpr extends AssignExpr implements Cloneable {
  /**
   * @aspect TypeCheck
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\TypeCheck.jrag:67
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java7\\frontend\\UncheckedConversion.jrag:53
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java7\\frontend\\SuppressWarnings.jrag:37
   */
  @ASTNodeAnnotation.Attribute
  ...
  public boolean Define_isDest(ASTNode caller, ASTNode child) {
    if (caller == getDestNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\DefiniteAssignment.jrag:39
      return true;
    }
    else {
      return super.Define_isDest(caller, child);
    }
  }
  /**
  ...
  public boolean Define_isSource(ASTNode caller, ASTNode child) {
    if (caller == getDestNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\DefiniteAssignment.jrag:49
      return false;
    }
    else {
      return super.Define_isSource(caller, child);
    }
  }
  /**
  ...
  public TypeDecl Define_assignConvertedType(ASTNode caller, ASTNode child) {
    if (caller == getSourceNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java5\\frontend\\GenericMethodsInference.jrag:61
      return getDest().type();
    }
    else {
