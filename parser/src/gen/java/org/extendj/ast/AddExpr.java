...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:155
...
public class AddExpr extends AdditiveExpr implements Cloneable {
  /**
   * @aspect TypeCheck
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\TypeCheck.jrag:204
   */
  ...
  public TypeDecl Define_targetType(ASTNode caller, ASTNode child) {
    if (caller == getRightOperandNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:53
      {
      ...
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:44
      {
      ...
      return super.Define_targetType(caller, child);
    }
  }
  /**
  ...
  public boolean Define_stringContext(ASTNode caller, ASTNode child) {
    if (caller == getRightOperandNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:234
      {
      ...
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:226
      {
          if (!getRightOperand().isPolyExpression() && !getLeftOperand().isPolyExpression()) {
      ...
      return super.Define_stringContext(caller, child);
    }
  }
  /**
   * @apilevel internal
