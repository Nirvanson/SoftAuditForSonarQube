...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:131
...
public class Dims extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\PrettyPrint.jadd:250
   */
  ...
  public boolean Define_assignmentContext(ASTNode caller, ASTNode child) {
    if (caller == getExprOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:379
      return false;
    }
    else {
  ...
  public boolean Define_invocationContext(ASTNode caller, ASTNode child) {
    if (caller == getExprOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:380
      return false;
    }
    else {
  ...
  public boolean Define_castContext(ASTNode caller, ASTNode child) {
    if (caller == getExprOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:381
      return false;
    }
    else {
  ...
  public boolean Define_stringContext(ASTNode caller, ASTNode child) {
    if (caller == getExprOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:382
      return false;
    }
    else {
  ...
  public boolean Define_numericContext(ASTNode caller, ASTNode child) {
    if (caller == getExprOptNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:383
      return false;
    }
    else {
