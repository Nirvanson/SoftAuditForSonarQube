...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\grammar\\Java.ast:96
...
public class MemberClassDecl extends MemberTypeDecl implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\PrettyPrint.jadd:299
   */
  ...
  public boolean Define_isMemberType(ASTNode caller, ASTNode child) {
    if (caller == getClassDeclNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\TypeAnalysis.jrag:578
      return true;
    }
    else {
  ...
  public boolean Define_inStaticContext(ASTNode caller, ASTNode child) {
    if (caller == getClassDeclNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java4\\frontend\\TypeHierarchyCheck.jrag:194
      return false;
    }
    else {
