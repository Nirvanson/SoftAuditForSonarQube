...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\grammar\\MethodReference.ast:1
...
public abstract class MethodReference extends Expr implements Cloneable {
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\NameCheck.jrag:512
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TypeCheck.jrag:227
   */
   ...
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:212
   */
   ...
   * @attribute syn
   * @aspect MethodReference
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:253
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @attribute syn
   * @aspect MethodReference
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:308
   */
  @ASTNodeAnnotation.Attribute
  ...
  public NameType Define_nameType(ASTNode caller, ASTNode child) {
    if (caller == getTypeArgumentListNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:194
