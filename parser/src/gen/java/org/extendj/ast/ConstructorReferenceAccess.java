...
/**
 * @ast node
 * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\grammar\\ConstructorReference.ast:5
...
public class ConstructorReferenceAccess extends ClassInstanceExpr implements Cloneable {
  /**
   * @aspect Synthetics
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:393
   */
  private FunctionDescriptor targetDescriptor;
  /**
   * @aspect Synthetics
   * @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\MethodReference.jrag:394
   */
  ...
  public TypeDecl Define_targetType(ASTNode caller, ASTNode child) {
    if (caller == getAccessNoTransform()) {
      // @declaredat C:\\Develop\\Diplom\\git_repo\\parser\\extendj\\java8\\frontend\\TargetType.jrag:189
